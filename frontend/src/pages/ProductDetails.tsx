          ...
          <div className="container mx-auto px-6">
            <div className="animate-pulse">
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  <div className="h-12 bg-muted/50 rounded-xl w-3/4"></div>
                  <div className="h-8 bg-muted/50 rounded-xl w-1/2"></div>
                  <div className="h-24 bg-muted/50 rounded-xl"></div>
                  <div className="h-14 bg-muted/50 rounded-xl w-full"></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="text-center max-w-2xl mx-auto">
              <div className="md:glass-card p-12 space-y-6">
                ...
                <Button 
                  size="lg" 
                  onClick={() => navigate('/')}
                  className="bg-gradient-premium hover:opacity-90 text-white font-semibold px-8 py-6 group"
                >
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex flex-wrap items-baseline gap-2">
                <span className="text-2xl sm:text-3xl font-bold text-gradient-gold">{formatPrice(product.price)}</span>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Button 
                      variant="gold"
                      size="lg" 
                      className="w-full sm:flex-1 h-12 sm:h-11 gap-2" 
                    ...
                    <Button 
                      size="lg" 
                      className="w-full sm:w-auto h-12 sm:h-11 px-8 bg-gradient-premium hover:opacity-90 text-white" 
