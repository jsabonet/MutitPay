      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-20">
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <Button size="lg" className="bg-gradient-premium hover:opacity-90 text-white font-semibold" asChild>
              <Link to="/">
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <Button variant="ghost" className="mb-4 hover:bg-accent/10" asChild>
              <Link to="/">
            ...
            <p className="text-muted-foreground text-lg">{items.length} {items.length === 1 ? 'item' : 'itens'} no seu carrinho</p>
          </div>
            ...
            <div className="space-y-6">
              <Card className="border-2 border-accent/20 bg-gradient-to-br from-card to-muted/30">
                ...
                <CardContent className="space-y-4 pt-6">
                  ...
                  {!appliedCoupon ? (
                    <div className="border-t border-b border-accent/20 py-3 space-y-2">
                      <div className="flex gap-2">
                        <Input
                          ...
                          className="uppercase text-sm h-9 border-accent/30 focus:border-accent"
                        />
                        <Button
                          variant="outline"
                          onClick={handleApplyCoupon}
                          disabled={isValidatingCoupon || !couponCode.trim()}
                          className="h-9 px-4 border-accent/30 hover:bg-accent/10 hover:border-accent"
                          size="sm"
                        >
                          {isValidatingCoupon ? (
                    ...
                    <div className="flex items-center justify-between border-t border-b border-accent/20 py-3 bg-green-50/50">
              ...
              <div className="space-y-3">
                <Button 
                  size="lg" 
                  className="w-full bg-gradient-premium hover:opacity-90 text-white font-semibold text-base shadow-lg hover:shadow-xl transition-all duration-300" 
              ...
              <Card className="border border-accent/20 bg-gradient-to-br from-card to-accent/5">
                <CardContent className="p-6">
                  <h4 className="font-semibold mb-3 text-base">Informações de Entrega</h4>
